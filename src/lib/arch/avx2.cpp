...
template void _vec_rem_scalar::operator()<xsimd::avx2>(xsimd::avx2, double *, double, int);
template void _vec_rem_vec::operator()<xsimd::avx2>(xsimd::avx2, double *, double *, int);
