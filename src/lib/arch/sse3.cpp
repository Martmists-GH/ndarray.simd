...
template void _vec_rem_scalar::operator()<xsimd::sse3>(xsimd::sse3, double *, double, int);
template void _vec_rem_vec::operator()<xsimd::sse3>(xsimd::sse3, double *, double *, int);
...
// Compare
template void _vec_eq_scalar::operator()<xsimd::sse3>(xsimd::sse3, double *, double, int, double, double, bool);
template void _vec_eq_vec::operator()<xsimd::sse3>(xsimd::sse3, double *, double *, int, double, double, bool);
template void _vec_neq_scalar::operator()<xsimd::sse3>(xsimd::sse3, double *, double, int, double, double, bool);
template void _vec_neq_vec::operator()<xsimd::sse3>(xsimd::sse3, double *, double *, int, double, double, bool);
