...
template void _vec_mul_scalar::operator()<xsimd::avx>(xsimd::avx, double *, double, int);
template void _vec_mul_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_div_scalar::operator()<xsimd::avx>(xsimd::avx, double *, double, int);
template void _vec_div_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_rem_scalar::operator()<xsimd::avx>(xsimd::avx, double *, double, int);
template void _vec_rem_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_negate::operator()<xsimd::avx>(xsimd::avx, double *, int);
template void _vec_abs::operator()<xsimd::avx>(xsimd::avx, double *, int);

// Bitwise
template void _vec_and_scalar::operator()<xsimd::avx>(xsimd::avx, double *, int, int);
template void _vec_and_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_or_scalar::operator()<xsimd::avx>(xsimd::avx, double *, int, int);
template void _vec_or_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_xor_scalar::operator()<xsimd::avx>(xsimd::avx, double *, int, int);
template void _vec_xor_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_not::operator()<xsimd::avx>(xsimd::avx, double *, int);
template void _vec_lshift_scalar::operator()<xsimd::avx>(xsimd::avx, double *, int, int);
template void _vec_lshift_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_rshift_scalar::operator()<xsimd::avx>(xsimd::avx, double *, int, int);
...
template void _vec_gt_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_lte_scalar::operator()<xsimd::avx>(xsimd::avx, double *, double, int);
template void _vec_lte_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
template void _vec_gte_scalar::operator()<xsimd::avx>(xsimd::avx, double *, double, int);
template void _vec_gte_vec::operator()<xsimd::avx>(xsimd::avx, double *, double *, int);
