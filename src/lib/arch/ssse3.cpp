...
// Compare
template void _vec_eq_scalar::operator()<xsimd::ssse3>(xsimd::ssse3, double *, double, int, double, double, bool);
template void _vec_eq_vec::operator()<xsimd::ssse3>(xsimd::ssse3, double *, double *, int, double, double, bool);
template void _vec_neq_scalar::operator()<xsimd::ssse3>(xsimd::ssse3, double *, double, int, double, double, bool);
template void _vec_neq_vec::operator()<xsimd::ssse3>(xsimd::ssse3, double *, double *, int, double, double, bool);
