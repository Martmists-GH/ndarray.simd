...
class BitwiseTest {
    ...
    fun `Test Array and Array`() {
        val arr1 = F64LargeDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 3.0 }, 0, F64Array.simdSize)
        val arr2 = F64LargeDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 5.0 }, 0, F64Array.simdSize)
    ...
    @Test
    fun `Test Array not`() {
        val arr1 = F64LargeDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 8.0 }, 0, F64Array.simdSize)
        val arr2 = arr1.not()
    ...
    fun `Test Array shr Array`() {
        val arr1 = F64LargeDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 40.0 }, 0, F64Array.simdSize)
        val arr2 = F64LargeDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 3.0 }, 0, F64Array.simdSize)
