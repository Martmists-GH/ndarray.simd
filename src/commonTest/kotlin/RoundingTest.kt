...
class RoundingTest {
    ...
    fun `Test Array floor`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 0.1 * it }, 0, F64Array.simdSize)
        val arr2 = arr1.floor()
    ...
    fun `Test Array round`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 0.2 * it }, 0, F64Array.simdSize)
        val arr2 = arr1.round()
