...
class ArithmeticTest {
    ...
    fun `Test Array + Array`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 1.0 }, 0, F64Array.simdSize)
        val arr2 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 1.0 }, 0, F64Array.simdSize)
        val arr3 = arr1 + arr2
    ...
    fun `Test Array + Scalar`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 0.0 }, 0, F64Array.simdSize)
        val scalar = 3.0
    ...
    fun `Test Array x Array`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 2.0 }, 0, F64Array.simdSize)
    ...
    fun `Test Array div Array`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 6.0 }, 0, F64Array.simdSize)
        val arr2 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 3.0 }, 0, F64Array.simdSize)
        val result = arr1 / arr2
    ...
    fun `Test Array div Scalar`() {
        val arr = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 6.0 }, 0, F64Array.simdSize)
        val scalar = 3.0
        val result = arr / scalar
        assertContentEquals(result.toDoubleArray(), DoubleArray(F64Array.simdSize) { 2.0 })
    }
    ...
    fun `Test Array rem Scalar`() {
        val arr = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 5.0 }, 0, F64Array.simdSize)
        val scalar = 3.0
        val result = arr % scalar
        assertContentEquals(result.toDoubleArray(), DoubleArray(F64Array.simdSize) { 2.0 })
    }
    ...
    @Test
    fun `Test Array abs`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { if (it % 2 == 0) 1.0 else -1.0 }, 0, F64Array.simdSize)
        val result = arr1.abs()
        assertContentEquals(result.toDoubleArray(), DoubleArray(F64Array.simdSize) { 1.0 })
    }
}
