...
class CompareTest {
    ...
    fun `Test Array = Array`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { if (it % 2 == 0) 1.0 else 2.0 }, 0, F64Array.simdSize)
        val arr2 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 2.0 }, 0, F64Array.simdSize)
    ...
    fun `Test Array lt Array`() {
        val arr1 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { if (it % 2 == 0) 1.0 else 2.0 }, 0, F64Array.simdSize)
        val arr2 = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { 1.5 }, 0, F64Array.simdSize)
    ...
    fun `Test Array isnan`() {
        ...
        val arr = F64SmallDenseFlatArrayImpl(DoubleArray(F64Array.simdSize) { options[it % options.size] }, 0, F64Array.simdSize)
        val arr2 = arr.isNan()
